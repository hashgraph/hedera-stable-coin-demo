...
public class RemoveDropChunksPolicy extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 578329969;
    ...
    /**
     * The parameter <code>public.remove_drop_chunks_policy.if_exists</code>.
     */
     ...
     */
    public RemoveDropChunksPolicy() {
        super("remove_drop_chunks_policy", Public.PUBLIC);
